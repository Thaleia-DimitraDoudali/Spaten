...
public class UserList implements Serializable, Compressible{
	...
	public String toString() {
		String res = "Friends of user no." + this.userId + ":\n";
	...
	public byte[] getDataBytes() throws Exception {
        ...
        for (User usr : this.userList) {
            ...
            numberOfBytes += usr.getDataBytes().length;
        }
        ...
        for (User usr : this.userList) {
            byte[] bytesPoi = usr.getDataBytes();
	...
	public static void main(String[] args) throws Exception {
		...
		UserList usrList = new UserList(usr1.getUserId());
		usrList.add(usr2);
		usrList.add(usr3);
