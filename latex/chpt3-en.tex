...
\subsection{Path between check-ins definition}
...
\begin{center}
 %https://maps.googleapis.com/maps/api/staticmap?&size=1000x1000&markers=label:A|25.08429,-80.442&markers=label:B|25.0947,-80.44&markers=label:C|25.09264,-80.4382&path=color:blue|enc:ygbxCni~iNY??k@??\{ACo@Aq@@s@Ai@AcN?_A?sACkA@iACM@gCAsCCsCAaBBK?C?C?C@A@CBABA@AB?B?F?D@R??QKIGMESIaBw@SK??GQGIOOk@m@UYa@c@OOu@y@e@m@EE??e@m@k@q@o@u@??b@_@nAyAj@m@hAmA??jDzD
\end{center}
The map that corresponds to the above URL is:

The generator stores the URLs created at the corresponding output file (outMaps), so that the image of the map can be accessible by the users of the generator.
